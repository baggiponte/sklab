...
3. Agents are encouraged to read the [ADR index](docs/contributing/adr/index.md) and the linked records to understand the project's current architectural decisions before proposing changes.
